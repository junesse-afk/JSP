...
public class ProductServlet extends HttpServlet {
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp) 
		...
		if (command.equals("/main.pr")) {
			...
			//int proudct_id = Integer.parseInt(req.getParameter("product_id"));
			//ProductDTO prod=new ProductDTO();
			//prod.setProuduct_id(product_id);
			//productDAO dao = new ProductDAO();
			//int insert = dao.insert(dao);
			...
			//String path = "jsp10_jdbc_product_";
			//path += insert > 0 ? "regist_success" : "fail";
